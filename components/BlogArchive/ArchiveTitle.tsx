  ...
  return (
    <div class="container-wrapper">
      <div class="h-[290px] lg:h-[500px] relative w-full bg-gradient-to-b from-[#18181B] via-gray-700 to-gray-600 bacon-background">
        ...
        <div
        class="z-10 text-white flex flex-col justify-center items-center h-full relative max-w-screen-md mx-auto pt-8"

        >
          <h1
          class="font-extrabold mb-4 text-xl max-w-xs text-center lg:text-4xl lg:max-w-max"
          >
            {category}
          </h1>
        </div>
