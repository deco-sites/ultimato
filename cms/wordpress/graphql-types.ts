...
export type ActionMonitorAction =
  & Node
  & ContentNode
...
/** Input for the createHQCatalogo mutation */
export type CreateHqCatalogoInput = {
  /**
   * This is an ID that can be passed to a mutation by the client to track the
   * progress of mutations and catch possible duplicate mutation submissions.
   */
...
/** The payload for the createHQCatalogo mutation */
export type CreateHqCatalogoPayload = {
  __typename?: "CreateHQCatalogoPayload";
  /** The Post object mutation type. */
  hQCatalogo?: Maybe<HqCatalogo>;
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will
   * be returned as output on the mutation. This ID can be used by the client to
   * track the progress of mutations and catch possible duplicate mutation submissions.
...
/** Input for the deleteHQCatalogo mutation */
export type DeleteHqCatalogoInput = {
  /**
   * This is an ID that can be passed to a mutation by the client to track the
   * progress of mutations and catch possible duplicate mutation submissions.
   */
  ...
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: Maybe<Scalars["Boolean"]>;
  /** The ID of the HQCatalogo to delete */
  id: Scalars["ID"];
};

/** The payload for the deleteHQCatalogo mutation */
export type DeleteHqCatalogoPayload = {
  __typename?: "DeleteHQCatalogoPayload";
  /** The object before it was deleted */
  hQCatalogo?: Maybe<HqCatalogo>;
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will
...
export type GatsbyPreviewData = {
  ...
  modified?: Maybe<Scalars["String"]>;
  /**
   * The WordPress database ID of the preview. If this is a draft it will
   * potentially return 0, if it&#039;s a revision of a post, it will return the ID
   * of the original post that this is a revision of.
   */
  parentDatabaseId?: Maybe<Scalars["Int"]>;
...
export type HqCatalogo =
  ...
  & MenuItemLinkable
  & {
    __typename?: "HQCatalogo";
    /**
     * The id field matches the WP_Post-&gt;ID field.
     * @deprecated Deprecated in favor of the databaseId field
     */
    hQCatalogoId: Scalars["Int"];
    /** Added to the GraphQL Schema because the ACF Field Group &quot;Parâmetros do Catálogo&quot; was set to Show in GraphQL. */
    catalogParameters?: Maybe<HqCatalogo_Catalogparameters>;
    /** The content of the post. */
    content?: Maybe<Scalars["String"]>;
    /** Connection between the ContentNode type and the ContentType type */
    contentType?: Maybe<ContentNodeToContentTypeConnectionEdge>;
     ...
     */
    guid?: Maybe<Scalars["String"]>;
    /** The globally unique identifier of the hq_catalogo object. */
    id: Scalars["ID"];
    /** Whether the node is a Content Node */
    isContentNode: Scalars["Boolean"];
    /** Whether the object is a node in the preview state */
     ...
     */
    modifiedGmt?: Maybe<Scalars["String"]>;
    /** Connection between the HQCatalogo type and the HQCatalogo type */
    preview?: Maybe<HqCatalogoToPreviewConnectionEdge>;
    /** The database id of the preview node */
    previewRevisionDatabaseId?: Maybe<Scalars["Int"]>;
    /** Whether the object is a node in the preview state */
    previewRevisionId?: Maybe<Scalars["ID"]>;
...
/** The HQCatalogo type */
export type HqCatalogoContentArgs = {
  format?: Maybe<PostObjectFieldFormatEnum>;
};

/** The HQCatalogo type */
export type HqCatalogoEnqueuedScriptsArgs = {
  first?: Maybe<Scalars["Int"]>;
  last?: Maybe<Scalars["Int"]>;
  after?: Maybe<Scalars["String"]>;
  before?: Maybe<Scalars["String"]>;
...
/** The HQCatalogo type */
export type HqCatalogoEnqueuedStylesheetsArgs = {
  first?: Maybe<Scalars["Int"]>;
  last?: Maybe<Scalars["Int"]>;
  after?: Maybe<Scalars["String"]>;
  before?: Maybe<Scalars["String"]>;
...
/** The HQCatalogo type */
export type HqCatalogoTitleArgs = {
  format?: Maybe<PostObjectFieldFormatEnum>;
};

/** Field Group */
export type HqCatalogo_Catalogparameters = AcfFieldGroup & {
  __typename?: "HQCatalogo_Catalogparameters";
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars["String"]>;
  link?: Maybe<AcfLink>;
  tituloLinha1?: Maybe<Scalars["String"]>;
  tituloLinha2?: Maybe<Scalars["String"]>;
};

/** The Type of Identifier used to fetch a single resource. Default is ID. */
export enum HqCatalogoIdType {
  /** Identify a resource by the Database ID. */
  DatabaseId = "DATABASE_ID",
  /** Identify a resource by the (hashed) Global ID. */
  Id = "ID",
...
/** Connection between the HQCatalogo type and the HQCatalogo type */
export type HqCatalogoToPreviewConnectionEdge = {
  __typename?: "HQCatalogoToPreviewConnectionEdge";
  /** The node of the connection, without the edges */
  node?: Maybe<HqCatalogo>;
};
...
export enum MediaItemSizeEnum {
  /** MediaItem with the highlight_banner size */
  HighlightBanner = "HIGHLIGHT_BANNER",
...
export type MenuItemObjectUnion = Post | Page | HqCatalogo | Category | Tag;
...
export type Page =
  ...
  & {
     ...
     */
    modifiedGmt?: Maybe<Scalars["String"]>;
    /** Added to the GraphQL Schema because the ACF Field Group &quot;Banner de Destaque&quot; was set to Show in GraphQL. */
    pageHighlight?: Maybe<Page_Pagehighlight>;
    /**
     * The id field matches the WP_Post-&gt;ID field.
     * @deprecated Deprecated in favor of the databaseId field
     */
...
/** Field Group */
export type Page_Pagehighlight = AcfFieldGroup & {
  __typename?: "Page_Pagehighlight";
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars["String"]>;
...
export type Post =
  ...
  & {
    __typename?: "Post";
    /** Added to the GraphQL Schema because the ACF Field Group &quot;Parâmetros de post&quot; was set to Show in GraphQL. */
    acfPostParams?: Maybe<Post_Acfpostparams>;
    /** Connection between the NodeWithAuthor type and the User type */
    author?: Maybe<NodeWithAuthorToUserConnectionEdge>;
    /** The database identifier of the author of the node */
    authorDatabaseId?: Maybe<Scalars["Int"]>;
...
/** Field Group */
export type Post_Acfpostparams = AcfFieldGroup & {
  __typename?: "Post_Acfpostparams";
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars["String"]>;
  postviews?: Maybe<Scalars["Float"]>;
};
...
export type RootMutation = {
  ...
  /** The payload for the createHQCatalogo mutation */
  createHQCatalogo?: Maybe<CreateHqCatalogoPayload>;
  /** The payload for the createMediaItem mutation */
  ...
  /** The payload for the deleteHQCatalogo mutation */
  deleteHQCatalogo?: Maybe<DeleteHqCatalogoPayload>;
  /** The payload for the deleteMediaItem mutation */
  ...
  /** The payload for the updateHQCatalogo mutation */
  updateHQCatalogo?: Maybe<UpdateHqCatalogoPayload>;
...
/** The root mutation */
export type RootMutationCreateHqCatalogoArgs = {
  input: CreateHqCatalogoInput;
};
...
/** The root mutation */
export type RootMutationDeleteHqCatalogoArgs = {
  input: DeleteHqCatalogoInput;
};
...
/** The root mutation */
export type RootMutationUpdateHqCatalogoArgs = {
  input: UpdateHqCatalogoInput;
};
...
export type RootQuery = {
  ...
  /** Connection between the RootQuery type and the HQCatalogo type */
  allHQCatalogo?: Maybe<RootQueryToHqCatalogoConnection>;
  ...
  /** An object of the HQCatalogo Type.  */
  hQCatalogo?: Maybe<HqCatalogo>;
  /**
   * A HQCatalogo object
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
   */
  hQCatalogoBy?: Maybe<HqCatalogo>;
...
/** The root entry point into the Graph */
export type RootQueryAllHqCatalogoArgs = {
  first?: Maybe<Scalars["Int"]>;
  last?: Maybe<Scalars["Int"]>;
  after?: Maybe<Scalars["String"]>;
  before?: Maybe<Scalars["String"]>;
  where?: Maybe<RootQueryToHqCatalogoConnectionWhereArgs>;
};
...
/** The root entry point into the Graph */
export type RootQueryHqCatalogoArgs = {
  id: Scalars["ID"];
  idType?: Maybe<HqCatalogoIdType>;
  asPreview?: Maybe<Scalars["Boolean"]>;
};

/** The root entry point into the Graph */
export type RootQueryHqCatalogoByArgs = {
  id?: Maybe<Scalars["ID"]>;
  hQCatalogoId?: Maybe<Scalars["Int"]>;
  uri?: Maybe<Scalars["String"]>;
  slug?: Maybe<Scalars["String"]>;
};
...
export type RootQueryToActionMonitorActionConnectionWhereArgs = {
  ...
  /** Specify IDs NOT to retrieve. If this is used in the same query as "in", it will be ignored */
  notIn?: Maybe<Array<Maybe<Scalars["ID"]>>>;
  /** Paginate ActionMonitorActions with offsets */
...
/** Connection between the RootQuery type and the HQCatalogo type */
export type RootQueryToHqCatalogoConnection = {
  __typename?: "RootQueryToHQCatalogoConnection";
  /** Edges for the RootQueryToHQCatalogoConnection connection */
  edges?: Maybe<Array<Maybe<RootQueryToHqCatalogoConnectionEdge>>>;
  /** The nodes of the connection, without the edges */
  nodes?: Maybe<Array<Maybe<HqCatalogo>>>;
  /** Information about pagination in a connection. */
  pageInfo?: Maybe<WpPageInfo>;
};

/** An edge in a connection */
export type RootQueryToHqCatalogoConnectionEdge = {
  __typename?: "RootQueryToHQCatalogoConnectionEdge";
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars["String"]>;
  /** The item at the end of the edge */
  node?: Maybe<HqCatalogo>;
...
/** Arguments for filtering the RootQueryToHQCatalogoConnection connection */
export type RootQueryToHqCatalogoConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery?: Maybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: Maybe<Scalars["Boolean"]>;
  ...
  /** Specify IDs NOT to retrieve. If this is used in the same query as "in", it will be ignored */
  notIn?: Maybe<Array<Maybe<Scalars["ID"]>>>;
  /** Paginate HQCatalogos with offsets */
  offsetPagination?: Maybe<OffsetPagination>;
  /** What paramater to use to order the objects by. */
  orderby?: Maybe<Array<Maybe<PostObjectsConnectionOrderbyInput>>>;
  /** Use ID to return only children. Use 0 to return only top-level items */
...
export type SeoContentTypes = {
  ...
  hQCatalogo?: Maybe<SeoContentType>;
...
/** Input for the updateHQCatalogo mutation */
export type UpdateHqCatalogoInput = {
  /**
   * This is an ID that can be passed to a mutation by the client to track the
   * progress of mutations and catch possible duplicate mutation submissions.
   */
   ...
   */
  date?: Maybe<Scalars["String"]>;
  /** The ID of the HQCatalogo object */
  id: Scalars["ID"];
  /**
   * A field used for ordering posts. This is typically used with nav menu items or
   * for special ordering of hierarchical content types.
...
/** The payload for the updateHQCatalogo mutation */
export type UpdateHqCatalogoPayload = {
  __typename?: "UpdateHQCatalogoPayload";
  /** The Post object mutation type. */
  hQCatalogo?: Maybe<HqCatalogo>;
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will
...
export type WpGatsbyRemotePreviewStatusInput = {
  ...
  parentDatabaseId?: Maybe<Scalars["Float"]>;
...
export enum WpGatsbyWpPreviewedNodeStatus {
  ...
  PreviewPageUpdatedButNotYetDeployed =
...
export type PostArchiveFieldsFragment =
  & { __typename?: "Post" }
  & Pick<
    Post,
    "id" | "title" | "excerpt" | "slug" | "date" | "readingTime"
  >
  & {
    categories?: Maybe<
      { __typename?: "PostToCategoryConnection" } & {
                ...
                ancestors?: Maybe<
                  { __typename?: "CategoryToAncestorsCategoryConnection" } & {
                    nodes?: Maybe<
                      Array<
                        Maybe<
                          { __typename?: "Category" } & Pick<Category, "slug">
                        >
                      >
                    >;
                  }
...
export type SeoFragment =
  ...
  & {
    opengraphImage?: Maybe<
      { __typename?: "MediaItem" } & Pick<MediaItem, "altText" | "sourceUrl">
    >;
    twitterImage?: Maybe<
...
export type MenuFieldsFragment =
  ...
  & Pick<
    MenuItem,
    "id" | "url" | "title" | "path" | "label"
  >;

export type MenuChildrenFragment = { __typename?: "MenuItem" } & {
  childItems?: Maybe<
    { __typename?: "MenuItemToMenuItemConnection" } & {
      nodes?: Maybe<
        Array<Maybe<{ __typename?: "MenuItem" } & MenuFieldsFragment>>
      >;
    }
  >;
};
